...
var (
	filter_WalletService_RemoveAddressesFromWalletEndpoint_0 = &utilities.DoubleArray{Encoding: map[string]int{"network": 0, "name": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	...
	pattern_WalletService_GenerateAddressInWalletEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 2, 5}, []string{"btc", "network", "wallets", "name", "addresses", "generate"}, ""))

	pattern_WalletService_DeriveAddressInWalletEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 2, 6}, []string{"btc", "network", "wallets", "hd", "name", "addresses", "derive"}, ""))
