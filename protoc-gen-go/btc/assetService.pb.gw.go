...
var (
	pattern_AssetService_GenerateAssetAddressEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"btc", "network", "oap", "addrs"}, ""))

	pattern_AssetService_IssueAssetEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"btc", "network", "oap", "issue"}, ""))

	pattern_AssetService_TransferAssetEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"btc", "network", "oap", "assetid", "transfer"}, ""))
