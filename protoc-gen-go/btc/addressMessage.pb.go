...
func (*GenerateMultisigAddressEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_0f3478cb9b925990, []int{4}
}
...
func (m *GenerateMultisigAddressEndpointRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GenerateMultisigAddressEndpointRequest.Merge(m, src)
}
