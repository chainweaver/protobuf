...
func (*TransactionHashEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_b16d6628b71301d6, []int{0}
}
...
func (*UnconfirmedTransactionsEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_b16d6628b71301d6, []int{1}
}
...
func (*NewTransactionEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_b16d6628b71301d6, []int{2}
}
...
func (*SendTransactionEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_b16d6628b71301d6, []int{3}
}
...
func (*PushRawTransactionEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_b16d6628b71301d6, []int{4}
}
...
func (*DecodeRawTransactionEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_b16d6628b71301d6, []int{5}
}
...
func (*DataEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_b16d6628b71301d6, []int{6}
}
...
func (*TransactionPropagationEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_b16d6628b71301d6, []int{7}
}
...
func init() {
	proto.RegisterFile("transactionMessage.proto", fileDescriptor_transactionMessage_b16d6628b71301d6)
}

var fileDescriptor_transactionMessage_b16d6628b71301d6 = []byte{
