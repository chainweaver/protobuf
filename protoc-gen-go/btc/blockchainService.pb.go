...
func init() {
	proto.RegisterFile("blockchainService.proto", fileDescriptor_blockchainService_9cd27b439dca4125)
}

var fileDescriptor_blockchainService_9cd27b439dca4125 = []byte{
