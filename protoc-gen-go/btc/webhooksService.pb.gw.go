...
var (
	pattern_WebHooksService_CreateWebHookEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"btc", "network", "hooks"}, ""))

	pattern_WebHooksService_ListWebHooksEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"btc", "network", "hooks"}, ""))

	pattern_WebHooksService_WebHookIDEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"btc", "network", "hooks", "webhookid"}, ""))

	pattern_WebHooksService_DeleteWebHookEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"btc", "network", "hooks", "webhookid"}, ""))
)
