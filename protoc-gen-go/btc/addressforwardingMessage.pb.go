...
func (*CreateForwardEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressforwardingMessage_3c2a1805f2ade854, []int{0}
}
...
func (*ListForwardsEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressforwardingMessage_3c2a1805f2ade854, []int{1}
}
...
func (*ListForwardsEndpointResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressforwardingMessage_3c2a1805f2ade854, []int{2}
}
...
func (dst *ListForwardsEndpointResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ListForwardsEndpointResponse.Merge(dst, src)
}
...
func (*DeleteForwardEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressforwardingMessage_3c2a1805f2ade854, []int{3}
}
...
func (*DeleteForwardEndpointResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressforwardingMessage_3c2a1805f2ade854, []int{4}
}
...
func init() {
	proto.RegisterFile("addressforwardingMessage.proto", fileDescriptor_addressforwardingMessage_3c2a1805f2ade854)
}

var fileDescriptor_addressforwardingMessage_3c2a1805f2ade854 = []byte{
