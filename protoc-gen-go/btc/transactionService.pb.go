...
func init() {
	proto.RegisterFile("transactionService.proto", fileDescriptor_transactionService_d0b23c26a5b061b8)
}

var fileDescriptor_transactionService_d0b23c26a5b061b8 = []byte{
