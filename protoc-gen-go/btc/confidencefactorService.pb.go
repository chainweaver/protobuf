...
func init() {
	proto.RegisterFile("confidencefactorService.proto", fileDescriptor_confidencefactorService_f01fe4a83322f01a)
}

var fileDescriptor_confidencefactorService_f01fe4a83322f01a = []byte{
