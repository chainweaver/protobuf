...
func (*Blockchain) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchainMessage_1e4abe78c5008f66, []int{0}
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchainMessage_1e4abe78c5008f66, []int{1}
}
...
func (*Feature) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchainMessage_1e4abe78c5008f66, []int{2}
}
...
func (*ChainEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchainMessage_1e4abe78c5008f66, []int{3}
}
...
func (*BlockHashEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchainMessage_1e4abe78c5008f66, []int{4}
}
...
func (*BlockHeightEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchainMessage_1e4abe78c5008f66, []int{5}
}
...
func (*FeatureEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_blockchainMessage_1e4abe78c5008f66, []int{6}
}
...
func init() {
	proto.RegisterFile("blockchainMessage.proto", fileDescriptor_blockchainMessage_1e4abe78c5008f66)
}

var fileDescriptor_blockchainMessage_1e4abe78c5008f66 = []byte{
	// 762 bytes of a gzipped FileDescriptorProto
	,
}
