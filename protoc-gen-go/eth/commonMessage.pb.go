...
type Blockchain struct {
	...
	MediumGasPrice uint64 `protobuf:"varint,11,opt,name=medium_gas_price,json=mediumGasPrice,proto3" json:"medium_gas_price,omitempty"`
	...
	LowGasPrice uint64 `protobuf:"varint,13,opt,name=low_gas_price,json=lowGasPrice,proto3" json:"low_gas_price,omitempty"`
	...
	LastForkHeight uint64 `protobuf:"varint,15,opt,name=last_fork_height,json=lastForkHeight,proto3" json:"last_fork_height,omitempty"`
...
type Block struct {
	...
	// Block version.
	Ver uint64 `protobuf:"varint,10,opt,name=ver,proto3" json:"ver,omitempty"`
	...
	NTx uint64 `protobuf:"varint,16,opt,name=n_tx,json=nTx,proto3" json:"n_tx,omitempty"`
...
type TXRef struct {
	...
	RefBalanceHex string `protobuf:"bytes,9,opt,name=ref_balance_hex,json=refBalanceHex,proto3" json:"ref_balance_hex,omitempty"`
	// Optional Time at which transaction was included in a block; only present for confirmed transactions.
	Confirmed string `protobuf:"bytes,10,opt,name=confirmed,proto3" json:"confirmed,omitempty"`
	...
	DoubleOf             string   `protobuf:"bytes,11,opt,name=double_of,json=doubleOf,proto3" json:"double_of,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type TX struct {
	...
	Ver uint64 `protobuf:"varint,15,opt,name=ver,proto3" json:"ver,omitempty"`
	// true if this is an attempted double spend; false otherwise.
	...
	VinSz uint64 `protobuf:"varint,17,opt,name=vin_sz,json=vinSz,proto3" json:"vin_sz,omitempty"`
	// Total number of outputs in the transaction.
	VoutSz uint64 `protobuf:"varint,18,opt,name=vout_sz,json=voutSz,proto3" json:"vout_sz,omitempty"`
	// Number of subsequent blocks, including the block the transaction is in. Unconfirmed transactions have 0 confirmations.
	...
	ReceiveCount uint64 `protobuf:"varint,28,opt,name=receive_count,json=receiveCount,proto3" json:"receive_count,omitempty"`
	...
	BlockIndex uint64 `protobuf:"varint,30,opt,name=block_index,json=blockIndex,proto3" json:"block_index,omitempty"`
	// Optional If this transaction is a double-spend (i.e. double_spend == true) then this is the hash of the transaction it’s double-spending.
...
type Address struct {
	...
	UnconfirmedBalance uint64 `protobuf:"varint,8,opt,name=unconfirmed_balance,json=unconfirmedBalance,proto3" json:"unconfirmed_balance,omitempty"`
	...
	FinalBalance uint64 `protobuf:"varint,10,opt,name=final_balance,json=finalBalance,proto3" json:"final_balance,omitempty"`
	...
	NTx uint64 `protobuf:"varint,12,opt,name=n_tx,json=nTx,proto3" json:"n_tx,omitempty"`
	// Number of unconfirmed transactions for this address. Only unconfirmed transactions (confirmations == 0) are counted.
	UnconfirmedNTx uint64 `protobuf:"varint,13,opt,name=unconfirmed_n_tx,json=unconfirmedNTx,proto3" json:"unconfirmed_n_tx,omitempty"`
	// Final number of transactions, including confirmed and unconfirmed transactions, for this address.
	FinalNTx uint64 `protobuf:"varint,14,opt,name=final_n_tx,json=finalNTx,proto3" json:"final_n_tx,omitempty"`
...
var fileDescriptor_commonMessage_082f954724480979 = []byte{
	...
	,
}
