...
func (*GetBalanceAddressEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressMessage_Eth_8d54144e4db6a5fb, []int{0}
}
...
func (dst *GetBalanceAddressEndpointRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetBalanceAddressEndpointRequest.Merge(dst, src)
}
...
func (*GetAddressEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressMessage_Eth_8d54144e4db6a5fb, []int{1}
}
...
func (dst *GetAddressEndpointRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetAddressEndpointRequest.Merge(dst, src)
}
...
func (*PostGenerateAddressEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_addressMessage_Eth_8d54144e4db6a5fb, []int{2}
}
...
func (dst *PostGenerateAddressEndpointRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PostGenerateAddressEndpointRequest.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("addressMessage_Eth.proto", fileDescriptor_addressMessage_Eth_8d54144e4db6a5fb)
}

var fileDescriptor_addressMessage_Eth_8d54144e4db6a5fb = []byte{
