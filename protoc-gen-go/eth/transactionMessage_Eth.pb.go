...
func (*TxArray) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_Eth_6286ef47441b8468, []int{0}
}
...
func (*GetTransactionHashEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_Eth_6286ef47441b8468, []int{1}
}
...
func (*GetUnconfirmedTransactionsEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_Eth_6286ef47441b8468, []int{2}
}
...
func (*PostCreateTransactionsEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_Eth_6286ef47441b8468, []int{3}
}
...
func (*PostSendTransactionEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_Eth_6286ef47441b8468, []int{4}
}
...
func (*PostDecodeRawTransactionEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_Eth_6286ef47441b8468, []int{5}
}
...
func (*PostPushRawTransactionEndpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transactionMessage_Eth_6286ef47441b8468, []int{6}
}
...
func init() {
	proto.RegisterFile("transactionMessage_Eth.proto", fileDescriptor_transactionMessage_Eth_6286ef47441b8468)
}

var fileDescriptor_transactionMessage_Eth_6286ef47441b8468 = []byte{
