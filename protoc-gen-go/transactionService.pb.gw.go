...
var (
	filter_TransactionService_TransactionHashEndpoint_0 = &utilities.DoubleArray{Encoding: map[string]int{"txhash": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)
...
var (
	pattern_TransactionService_TransactionHashEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"txs", "txhash"}, ""))

	pattern_TransactionService_UnconfirmedTransactionsEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"txs"}, ""))

	pattern_TransactionService_NewTransactionEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"txs", "new"}, ""))

	pattern_TransactionService_SendTransactionEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"txs", "send"}, ""))

	pattern_TransactionService_PushRawTransactionEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"txs", "push"}, ""))

	pattern_TransactionService_DecodeRawTransactionEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"txs", "decode"}, ""))

	pattern_TransactionService_DataEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"txs", "data"}, ""))

	pattern_TransactionService_TransactionPropagationEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"txs", "txhash", "propagation"}, ""))
)
