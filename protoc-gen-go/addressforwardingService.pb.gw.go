...
var (
	filter_AddressForwardingService_ListForwardsEndpoint_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	pattern_AddressForwardingService_CreateForwardEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"forwards"}, ""))

	pattern_AddressForwardingService_ListForwardsEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"forwards"}, ""))

	pattern_AddressForwardingService_DeleteForwardEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"forwards", "payid"}, ""))
)
