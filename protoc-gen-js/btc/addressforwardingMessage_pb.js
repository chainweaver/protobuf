...
goog.exportSymbol('proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards', null, global);
 ...
 * @constructor
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.repeatedFields_, null);
};
goog.inherits(proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.displayName = 'proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.prototype.toObject = function(opt_includeInstance) {
  return proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards}
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards;
  return proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards}
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.prototype.getForwardsList = function() {
...
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.prototype.setForwardsList = function(value) {
 ...
 */
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.prototype.addForwards = function(opt_value, opt_index) {
...
proto.fairwaycorp.blockchainprotobuf.btc.AddressForwards.prototype.clearForwardsList = function() {
