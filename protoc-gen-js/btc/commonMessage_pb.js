...
goog.exportSymbol('proto.fairwaycorp.blockchainprotobuf.btc.Event', null, global);
...
goog.exportSymbol('proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation', null, global);
...
proto.fairwaycorp.blockchainprotobuf.btc.TX.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    received: jspb.Message.getFieldWithDefault(msg, 9, ""),
    ...
    nextInputs: jspb.Message.getFieldWithDefault(msg, 28, ""),
    nextOutputs: jspb.Message.getFieldWithDefault(msg, 29, "")
  };
...
/**
 * optional string next_inputs = 28;
 * @return {string}
 */
...
/**
 * optional string next_outputs = 29;
 * @return {string}
 */
...
proto.fairwaycorp.blockchainprotobuf.btc.Address.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    txUrl: jspb.Message.getFieldWithDefault(msg, 12, ""),
...
proto.fairwaycorp.blockchainprotobuf.btc.TXRef.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    confirmed: jspb.Message.getFieldWithDefault(msg, 14, ""),
...
proto.fairwaycorp.blockchainprotobuf.btc.OAPTX.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    confirmed: jspb.Message.getFieldWithDefault(msg, 4, ""),
    received: jspb.Message.getFieldWithDefault(msg, 5, ""),
    oapMeta: jspb.Message.getFieldWithDefault(msg, 6, ""),
    doubleSpend: jspb.Message.getFieldWithDefault(msg, 7, false),
    inputsList: jspb.Message.getRepeatedField(msg, 8),
    outputsList: jspb.Message.getRepeatedField(msg, 9)
  };
 ...
 * @constructor
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.displayName = 'proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation';
}
 ...
 * @return {!Object}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.toObject = function(opt_includeInstance) {
  return proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    firstReceived: jspb.Message.getFieldWithDefault(msg, 7, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation;
  return proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.getTransaction = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.setTransaction = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.getFirstLocation = function() {
...
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.setFirstLocation = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.clearFirstLocation = function() {
 ...
 * @return {!boolean}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.hasFirstLocation = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.getFirstCity = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.setFirstCity = function(value) {
  jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.getFirstCountry = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.setFirstCountry = function(value) {
  jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.getAggregatedOrigin = function() {
...
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.setAggregatedOrigin = function(value) {
  jspb.Message.setWrapperField(this, 5, value);
};


proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.clearAggregatedOrigin = function() {
 ...
 * @return {!boolean}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.hasAggregatedOrigin = function() {
 ...
 * @return {number}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.getAggregatedOriginRadius = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};


/** @param {number} value */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.setAggregatedOriginRadius = function(value) {
  jspb.Message.setProto3IntField(this, 6, value);
};


/**
 * optional string first_received = 7;
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.getFirstReceived = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 7, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.TXPropagation.prototype.setFirstReceived = function(value) {
  jspb.Message.setProto3StringField(this, 7, value);
};
...
proto.fairwaycorp.blockchainprotobuf.btc.Job.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    resultPath: jspb.Message.getFieldWithDefault(msg, 8, ""),
...
proto.fairwaycorp.blockchainprotobuf.btc.TXConfidence.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    txurl: jspb.Message.getFieldWithDefault(msg, 5, "")
  };
 ...
 * @constructor
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.fairwaycorp.blockchainprotobuf.btc.Event, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.fairwaycorp.blockchainprotobuf.btc.Event.displayName = 'proto.fairwaycorp.blockchainprotobuf.btc.Event';
}
 ...
 * @return {!Object}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.toObject = function(opt_includeInstance) {
  return proto.fairwaycorp.blockchainprotobuf.btc.Event.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.Event} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    event: jspb.Message.getFieldWithDefault(msg, 2, ""),
    hash: jspb.Message.getFieldWithDefault(msg, 3, ""),
    walletName: jspb.Message.getFieldWithDefault(msg, 4, ""),
    ...
    confidence: +jspb.Message.getFieldWithDefault(msg, 8, 0.0),
    script: jspb.Message.getFieldWithDefault(msg, 9, ""),
    url: jspb.Message.getFieldWithDefault(msg, 10, ""),
    callbackErrors: jspb.Message.getFieldWithDefault(msg, 11, 0)
  };
 ...
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.fairwaycorp.blockchainprotobuf.btc.Event;
  return proto.fairwaycorp.blockchainprotobuf.btc.Event.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.Event} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.fairwaycorp.blockchainprotobuf.btc.Event}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.fairwaycorp.blockchainprotobuf.btc.Event.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.fairwaycorp.blockchainprotobuf.btc.Event} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setId = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getEvent = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setEvent = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getHash = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setHash = function(value) {
  jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getWalletName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setWalletName = function(value) {
  jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setToken = function(value) {
  jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setAddress = function(value) {
  jspb.Message.setProto3StringField(this, 6, value);
};
 ...
 * @return {number}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getConfirmations = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};


/** @param {number} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setConfirmations = function(value) {
  jspb.Message.setProto3IntField(this, 7, value);
};
 ...
 * @return {number}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getConfidence = function() {
  return /** @type {number} */ (+jspb.Message.getFieldWithDefault(this, 8, 0.0));
};


/** @param {number} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setConfidence = function(value) {
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getScript = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 9, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setScript = function(value) {
  jspb.Message.setProto3StringField(this, 9, value);
};
 ...
 * @return {string}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getUrl = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 10, ""));
};


/** @param {string} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setUrl = function(value) {
  jspb.Message.setProto3StringField(this, 10, value);
};


/**
 * optional int32 callback_errors = 11;
 * @return {number}
 */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.getCallbackErrors = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 11, 0));
};


/** @param {number} value */
proto.fairwaycorp.blockchainprotobuf.btc.Event.prototype.setCallbackErrors = function(value) {
  jspb.Message.setProto3IntField(this, 11, value);
};
