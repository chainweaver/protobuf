...
docker-build-protobuf-builder:
	docker build -t quay.io/chainweaver/protobuf-builder:1.3.2 -f build/dockerfiles/Dockerfile-ProtobufBuilder .
docker-build-protobuf-document-renderer:
	docker build -t quay.io/chainweaver/protobuf-document-renderer:1.1.0 -f build/dockerfiles/Dockerfile-ProtobufDocumentRenderer .
...
build:
	docker run -e CIRCLE_BRANCH -e CIRCLE_TAG -e CIRCLE_SHA1 -v ${PWD}:/go/src/github.com/chainweaver/protobuf quay.io/chainweaver/protobuf-builder:1.3.2
