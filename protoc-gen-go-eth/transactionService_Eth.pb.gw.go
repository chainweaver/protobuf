...
var (
	pattern_TransactionService_GetTransactionHashEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"eth", "stage", "txs", "txhash"}, ""))

	pattern_TransactionService_GetUnconfirmedTransactionsEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"eth", "stage", "txs"}, ""))

	pattern_TransactionService_PostCreateTransactionsEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"eth", "stage", "txs", "new"}, ""))

	pattern_TransactionService_PostSendTransactionEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"eth", "stage", "txs", "send"}, ""))

	pattern_TransactionService_PostDecodeRawTransactionEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"eth", "stage", "txs", "decode"}, ""))

	pattern_TransactionService_PostPushRawTransactionEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 2, 3}, []string{"eth", "stage", "txs", "push"}, ""))
)
