...
var (
	filter_BlockchainService_BlockHashEndpoint_0 = &utilities.DoubleArray{Encoding: map[string]int{"stage": 0, "block_hash": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	filter_BlockchainService_BlockHeightEndpoint_0 = &utilities.DoubleArray{Encoding: map[string]int{"stage": 0, "block_height": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	pattern_BlockchainService_ChainEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 1, 0}, []string{"eth", "stage"}, ""))

	pattern_BlockchainService_BlockHashEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"eth", "stage", "blocks", "block_hash"}, ""))

	pattern_BlockchainService_BlockHeightEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"eth", "stage", "blocks", "block_height"}, ""))
)
