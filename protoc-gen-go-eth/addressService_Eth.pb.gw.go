...
var (
	filter_AddressService_GetAddressEndpoint_0 = &utilities.DoubleArray{Encoding: map[string]int{"stage": 0, "address": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	pattern_AddressService_GetBalanceAddressEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"eth", "stage", "addrs", "address", "balance"}, ""))

	pattern_AddressService_GetAddressEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"eth", "stage", "addr", "address"}, ""))

	pattern_AddressService_PostGenerateAddressEndpoint_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"eth", "stage", "addr"}, ""))
)
